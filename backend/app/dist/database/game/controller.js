...
exports.getCompletedGame = getCompletedGame;
const session_1 = require("@gameLogic/sync/session");
const Service = __importStar(require("./service"));
function getGame(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const gameId = req.params.id;
        const gameData = session_1.SESSIONS.get(gameId);
        if (!gameData)
...
function getCompletedGame(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const data = yield Service.readCompletedGame(req.params.id, req.userId);
        res.status(200).json({ success: true, data });
    });
}
